...
<div class="container">
    ...
    <p class="tech-text">
        ...
        them if it is possible. For more information and some examples of proper warm-ups feel free to check out our Warm-Up section.
    </p>
    ...
    <p class="tech-text">
        ...
        yourself, and having to take several days or weeks off to recover.
    </p>
    ...
    <p class="tech-text">
        ...
        rotating the types of training you do every other day, you will engage and strengthen more of your muscles, giving you a better overall workout and improving your strength.
    </p>
    ...
    <p class="tech-text">
        ...
        will pay off in the end. To see some examples of proper technique check out our Workouts section.
    </p>
    ...
    <p class="tech-text">
        ...
        minutes or so during exercise. Follow up your workout with another 400ml-500ml within two hours of finishing to replace lost fluids.
    </p>
    ...
    <p class="tech-text">
        ...
        and risking injury. If necessary, consult with a professional or a trainer to see if there is an adjustment you need to make in order to avoid pain.
    </p>
    ...
    <p class="tech-text">
        ...
        above precautions, and have fun while exploring something new.
    </p>
    ...
    <p class="tech-text">
        ...
        the teenage years can have far-reaching consequences as they transition to adulthood. So lets take a look at most common mistakes in posture below. (Images from the NHS website).
    </p>
