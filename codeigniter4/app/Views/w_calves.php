...
<h2 class="text-center workout-header">Calves Exercises</h2>
...
<?php 
	if(isset($_POST['but_sort_1'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner' OR `user_category`='Calves' AND user_difficulty='Intermediate' OR `user_category`='Calves' AND user_difficulty='Hard' ORDER BY user_difficulty ASC";
    }
	else if(isset($_POST['but_sort_2'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner' OR `user_category`='Calves' AND user_difficulty='Intermediate' OR `user_category`='Calves' AND user_difficulty='Hard' ORDER BY user_difficulty DESC";
    }
	else if(isset($_POST['but_sort_3'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner' OR `user_category`='Calves' AND user_difficulty='Intermediate' OR `user_category`='Calves' AND user_difficulty='Hard' ORDER BY user_name ASC";
    }
	else if(isset($_POST['but_sort_4'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner' OR `user_category`='Calves' AND user_difficulty='Intermediate' OR `user_category`='Calves' AND user_difficulty='Hard' ORDER BY user_name DESC";
    }
    else if(isset($_POST['but_filter_1'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner'";
    }
	else if(isset($_POST['but_filter_2'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Intermediate'";
    }
	else if(isset($_POST['but_filter_3'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Hard'";
    }
	else if(isset($_POST['but_clear'])) {
        $query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner' OR `user_category`='Calves' AND user_difficulty='Intermediate' OR `user_category`='Calves' AND user_difficulty='Hard' ";
    }
	else{
		$query = "SELECT * FROM user_workouts WHERE `user_category`='Calves' AND user_difficulty='Beginner' OR `user_category`='Calves' AND user_difficulty='Intermediate' OR `user_category`='Calves' AND user_difficulty='Hard' ";
	}
