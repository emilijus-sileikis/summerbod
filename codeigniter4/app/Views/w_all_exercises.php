...
<?php 
	if(isset($_POST['but_sort_1'])) {
        $query = "SELECT * FROM user_workouts WHERE user_difficulty='Beginner' OR user_difficulty='Intermediate' OR user_difficulty='Hard' ORDER BY user_difficulty ASC";
    }
	else if(isset($_POST['but_sort_2'])) {
        $query = "SELECT * FROM user_workouts WHERE user_difficulty='Beginner' OR user_difficulty='Intermediate' OR user_difficulty='Hard' ORDER BY user_difficulty DESC";
    }
	else if(isset($_POST['but_sort_3'])) {
        $query = "SELECT * FROM user_workouts WHERE user_difficulty='Beginner' OR user_difficulty='Intermediate' OR user_difficulty='Hard' ORDER BY user_name ASC";
    }
	else if(isset($_POST['but_sort_4'])) {
        $query = "SELECT * FROM user_workouts WHERE user_difficulty='Beginner' OR user_difficulty='Intermediate' OR user_difficulty='Hard' ORDER BY user_name DESC";
    }
        ...
        $query = "SELECT * FROM user_workouts WHERE user_difficulty='Beginner' OR user_difficulty='Intermediate' OR user_difficulty='Hard' ";
    }
	else{
		$query = "SELECT * FROM user_workouts WHERE user_difficulty='Beginner' OR user_difficulty='Intermediate' OR user_difficulty='Hard' ";
	}
