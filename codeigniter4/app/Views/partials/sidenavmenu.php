...
<div id="mySidenav" class="sidenav">
    <ul>
        <li> <a href="<?php echo base_url('public/warmups'); ?>">Warm-ups</a> </li>
	    <li> <a href="<?php echo base_url('public/Techniques/t_all_techniques'); ?>">Exercise Techniques</a>
	    ...
	    <li> <a href="<?php echo base_url('public/Workouts/w_all_exercises'); ?>">Muscle Groups</a>
        <li style="list-style-type: none;">
